...
This project serves as a structured, centralized knowledge base for **AI education**. It categorizes hundreds of free courses, tracks their stability, and provides direct access to learning materials from universities, tech companies, and online platforms. **This project is part of Q-Repo, a huge repository of free online courses for everyone. Hosted by the Quantum CyberSec Community**

## 🎓 Featured Course Picks by Level

Based on community feedback and our own experience, here are our recommended starting points. If these don't suit your needs, explore the [Dynamic Institutions](/institutions/dynamic) to search through vast, updated catalogs.

| Level | Course | Institution | Direct Link |
| :--- | :--- | :--- | :--- |
| **Beginner** | Elements of AI | University of Helsinki | [Link](/institutions/stable/university-helsinki.md) |
| **Beginner** | Machine Learning Crash Course | Google Developers | [Link](/institutions/stable/google.md) |
| **Intermediate** | Intro to Deep Learning | Kaggle | [Link](/institutions/stable/kaggle.md) |
| **Intermediate** | PRDV430: AI for Business Applications | Saylor Academy | [Link](/institutions/stable/saylor-academy.md) |
...
This repository is organized into two main directories that classify courses by their **source** and by their **subject**.

### 1.  `/institutions` – Courses by Source
This directory organizes courses based on where they come from and how often they are updated.
...
| Category File | Description | Example Topics |
| :--- | :--- | :--- |
| `ai-fundamentals-ethics.md` | Foundational concepts, history, and ethical considerations | AI ethics, responsible AI, AI history, societal impact |
| `deep-learning.md` | Advanced neural architectures and applications | CNNs, RNNs, Transformers, Computer Vision, NLP |
| `generative-ai.md` | Content generation and large language models | GPT models, Diffusion models, LLM fine-tuning, prompt engineering |
| `machine-learning.md` | Traditional and applied machine learning | Supervised/unsupervised learning, regression, classification, clustering |
| `tools-frameworks.md` | Development tools, deployment, and MLOps | PyTorch, TensorFlow, MLflow, Kubernetes, cloud platforms |

**How it works**: Each category file contains:
